...
if(!function_exists('etheme_redux_init')) {
    function etheme_redux_init() {
        ...
        $args = array(
            ...
            'display_name'         => ETHEME_THEME_NAME . ' <span>' . esc_html__('8theme WordPress Theme - W  P  L  O  C  K  E  R  .  C  O  M', 'xstore') .'</span>',
        ...
        Redux::setSection( $opt_name, array(
            ...
            'fields' => array (
                array (
                    'id' => 'footer_color',
                    'type' => 'select',
                    'title' => 'Footer text color scheme - W_P_L_O_C_K_E_R_._C_O_M',
                    'options' => array (
                        'light' => 'Light',
                        'dark' => 'Dark',
                    ),
        ...
        Redux::setSection( $opt_name, array(
            ...
            'fields' => array(
                ...
                array (
                    ...
                    'type' => 'typography',
                    'title' => 'Headings',
                    'output' => 'h1, h2, h3, h4, h5, h6, .title h3, blockquote, .share-post .share-title, .sidebar-widget .tabs .tab-title, .widget-title, .related-posts .title span, .posts-slider article h2 a, .content-product .product-title a, table.cart .product-details a, .product_list_widget .product-title a, .woocommerce table.wishlist_table .product-name a, .comment-reply-title, .et-tabs .vc_tta-title-text, .single-product-right .product-information-inner .product_title, .single-product-right .product-information-inner h1.title',
                    'text-align' => false,
                    'font-size' => false,
                    'text-transform' => true,
                ),
